...
class Kiwi(Fruta):
    ...
    def __str__(self):
        ...
        """
        return(f"Kiwi ({self.peso_del_alimento}kg)")
...
class Manzana(Fruta):
    ...
    def __str__(self):
        """método que devuelve una cadena de texto que incluye el nombre y el peso del alimento
        """
        return(f"Manzana ({self.peso_del_alimento}kg)")
...
class Papa(Verdura):
    ...
    def __str__(self):
        """método que devuelve una cadena de texto que incluye el nombre y el peso del alimento
        """
        return(f"Papa ({self.peso_del_alimento}kg)")
...
class Zanahoria(Verdura):
    ...
    def __str__(self):
        """método que devuelve una cadena de texto que incluye el nombre y el peso del alimento
        """
        return f"Zanahoria ({self.peso_del_alimento}kg)"
...
class AlimentoInvalido(Alimentos):
    ...
    def __str__(self):
        return f"Alimento inválido ({self.peso_del_alimento}kg)"
