...
class TestCinta(unittest.TestCase):
    ...
    def test_clasificar_alimento(self):
        ...
        for alimento in cajon:
            ...
            self.assertGreater(alimento.peso_del_alimento, 0, "El peso del alimento debe ser mayor que 0")
            self.assertLessEqual(alimento.peso_del_alimento, 1000, "El peso del alimento debe ser menor o igual a 1000")
