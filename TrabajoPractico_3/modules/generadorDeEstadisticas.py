...
from monticulos import MonticuloMediana

class generadorDeEstadisticas:
    def __init__(self, datos):
        self.__datos = datos
        self.__monticulo = MonticuloMediana()
    ...
    def obtenerPorcentajesReclamos(self, reclamos):
        """
        Calcula el porcentaje de reclamos por estado.
